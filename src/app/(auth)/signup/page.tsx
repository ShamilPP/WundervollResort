...
import { Hotel, User, Mail, Lock, ChevronRight } from 'lucide-react'
...
export default function SignupPage() {
  ...
  async function onSubmit(e: React.FormEvent) {
    ...
    toast.success('Welcome to the Wundervoll Sanctuary')
    router.push('/')
    router.refresh()
  }
    ...
    <main className="min-h-screen bg-[#FDFCFB] flex items-center justify-center p-6">
      ...
      >
        ...
        <div className="text-center space-y-4">
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-center gap-3">
              ...
              <span className="text-[10px] font-black uppercase tracking-[0.6em] text-accent">Join Us</span>
              <div className="h-px w-8 bg-accent" />
            </div>
            <h1 className="font-serif text-5xl text-obsidian tracking-tighter">Begin Your <span className="text-accent italic font-light">Stay</span></h1>
            <p className="text-sm font-light text-obsidian/40 italic">{"\"Join Wundervoll to book and manage your oceanfront escape.\""}</p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-[3rem] border border-obsidian/5 p-10 shadow-sm space-y-8">
          ...
          <GoogleButton callbackUrl="/" label="Join with Google" />
        ...
        <div className="text-center space-y-4">
          ...
          <p className="text-[9px] font-medium text-obsidian/20 uppercase tracking-[0.4em]">
            © Wundervoll Resort · Secure Member Gateway
          </p>
        </div>
      </motion.div>
    </main>
